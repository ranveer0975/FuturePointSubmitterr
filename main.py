# main.py (your working code was already verified and used)
import sqlite3
import requests
...
FIREBASE_API_KEY = "AIzaSyByvsaiGZclQYfzE7XgM2rEYR9spDUNAZY"  # Replace with actual Web API Key
...
class FuturePointSubmitApp(MDApp):
    ...
    def upload_to_firestore(self, data):
        ...
        doc = {"fields": {k: {"stringValue": str(v)} for k, v in data.items()}}
        try:
